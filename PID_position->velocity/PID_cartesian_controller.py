...
class CartesianPIDController(Node):
    def __init__(self):
        ...
        self.alpha = 0.15       # joint smoothing (lower = smoother)
        self.max_dq = 0.15      # velocity limit
        self.max_ddq = 0.4      # acceleration limit
    ...
    def control_loop(self):
        ...
        J_pos = J[:3, :]  # translation part only

        # -------------------------
        # Estimate Cartesian velocity (damping term)
        # -------------------------
        ...
        # -------------------------
        # Damped Cartesian control law
        # -------------------------
        v_cmd = self.Kp * e_t - self.Kd * x_dot

        # -------------------------
        # Jacobian inverse (damped least squares)
        # -------------------------
        lam = 1e-4
